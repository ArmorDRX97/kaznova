...
<header class="d-lg-block d-none header @if(Request::is('/')) home-main-page @endif">
    <div class="container">
                ...
                <div class="dropdown header-icon d-lg-flex  justify-content-end d-none position-relative">
                    ...
                    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample"
                        ...
                        <div class="offcanvas-content pt-60">
                            ...
                            <div class="d-flex flex-wrap justify-content-sm-between justify-content-end align-items-center">
                                @if(getLogInUser())
                                    ...
                                    <ul class="mb-0 ps-0">
                                        <li class="nav-item">
                                            <a class="nav-link fs-14 p-0 "
                                               href="javascript:void(0)"> {{ getFrontSelectLanguageName() }} <i
