...
@section('content')
    ...
    <div class="news-details-page mb-20">
        <div class="breadcrumb-section pt-5">
            <div class="container">
                    ...
                    <div class="col-xl-8">
                        ...
                        <section class="news-details-left pe-xxl-3">
                            <div class="news-details">
                                <h3 class="text-black fw-7 fs-24 mb-3">{!! $postDetail->title !!}</h3>
                                <div class="post-content">
                                    <p class="text-gray">{!! $postDetail->description !!}</p>
                                </div>
                             <div class="d-flex align-items-center mb-3">
                                 <a href="#" class="tags">{{$postDetail->category->name}}</a>
                                 <p class="date-detail text-gray">{{ ucfirst(__('messages.common.'.strtolower($postDetail['created_at']->format('M')))) }} {{ $postDetail['created_at']->format('d, Y') }}</p>
                             </div>
                            ...
                            <section class="share-this-post-section mt-2 pt-md-3">
                                <div class="row admin-desc d-flex flex-wrap justify-content-between mb-20">
                                    @if(!empty(($postDetail->tags)))
                                        <div class="col-sm-12">
                                            <h5 class="fs-16 fw-6 text-black mt-2 pb-1 mx-2 float-start"> {{ __('messages.common.tags') }} </h5>
